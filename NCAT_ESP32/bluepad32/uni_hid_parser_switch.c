...
static void process_reply_req_dev_info(struct uni_hid_device_s* d, const struct switch_report_21_s* r, int len) {
    ...
    ins->controller_type = (switch_controller_types)r->data[2]; ///
...
static void parse_report_30_pro_controller(uni_hid_device_t* d, const struct switch_report_30_s* r) {
    ...
    gp->buttons |= (r->buttons_right & 0b00000100) ? BUTTON_A_ : 0;           // B
    gp->buttons |= (r->buttons_right & 0b00001000) ? BUTTON_B_ : 0;           // A
...
static void parse_report_30_joycon_left(uni_hid_device_t* d, const struct switch_report_30_s* r) {
    ...
    // Buttons
    gp->buttons |= (r->buttons_left & 0b00000001) ? BUTTON_B_ : 0;
    gp->buttons |= (r->buttons_left & 0b00000010) ? BUTTON_X : 0;
    gp->buttons |= (r->buttons_left & 0b00000100) ? BUTTON_Y : 0;
    gp->buttons |= (r->buttons_left & 0b00001000) ? BUTTON_A_ : 0;
...
static void parse_report_30_joycon_right(uni_hid_device_t* d, const struct switch_report_30_s* r) {
    ...
    gp->buttons |= (r->buttons_right & 0b00000010) ? BUTTON_B_ : 0;
    gp->buttons |= (r->buttons_right & 0b00000100) ? BUTTON_X : 0;
    gp->buttons |= (r->buttons_right & 0b00001000) ? BUTTON_A_ : 0;
...
static void parse_report_3f(struct uni_hid_device_s* d, const uint8_t* report, int len) {
    ...
    // Button main
    gp->buttons |= (r->buttons_main & 0b00000001) ? BUTTON_A_ : 0;           // B
    gp->buttons |= (r->buttons_main & 0b00000010) ? BUTTON_B_ : 0;           // A

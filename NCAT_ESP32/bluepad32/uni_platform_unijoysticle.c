...
struct uni_gpio_config uni_gpio_config_v2 = {
///
/*
...
struct uni_gpio_config uni_gpio_config_v2plus = {
///
/*    
...
struct uni_gpio_config uni_gpio_config_singleport = {
///
/*    
...
static const bd_addr_t BLUEPAD_zero_addr = {0, 0, 0, 0, 0, 0}; ///
...
static void unijoysticle_init(int argc, const char** argv) {
    ...
    uni_gpio_config_v2.port_a[0] = GPIO_NUM_26; ///
    uni_gpio_config_v2.port_a[1] = GPIO_NUM_18; ///
    uni_gpio_config_v2.port_a[2] = GPIO_NUM_19; ///
    uni_gpio_config_v2.port_a[3] = GPIO_NUM_23; ///
    uni_gpio_config_v2.port_a[4] = GPIO_NUM_14; ///
    uni_gpio_config_v2.port_a[5] = (gpio_num_t)-1; ///
    uni_gpio_config_v2.port_a[6] = (gpio_num_t)-1; ///
    uni_gpio_config_v2.port_b[0] = GPIO_NUM_27;
    uni_gpio_config_v2.port_b[1] = GPIO_NUM_25;
    uni_gpio_config_v2.port_b[2] = GPIO_NUM_32;
    uni_gpio_config_v2.port_b[3] = GPIO_NUM_17;
    uni_gpio_config_v2.port_b[4] = GPIO_NUM_12;
    uni_gpio_config_v2.port_b[5] = (gpio_num_t)-1; ///
    uni_gpio_config_v2.port_b[6] = (gpio_num_t)-1; ///
    uni_gpio_config_v2.led_j1 = GPIO_NUM_5; ///
    uni_gpio_config_v2.led_j2 = GPIO_NUM_13; ///
    uni_gpio_config_v2.push_button = GPIO_NUM_10; ///

    uni_gpio_config_v2plus.port_a[0] = GPIO_NUM_26; ///
    uni_gpio_config_v2plus.port_a[1] = GPIO_NUM_18; ///
    uni_gpio_config_v2plus.port_a[2] = GPIO_NUM_19; ///
    uni_gpio_config_v2plus.port_a[3] = GPIO_NUM_23; ///
    uni_gpio_config_v2plus.port_a[4] = GPIO_NUM_14; ///
    uni_gpio_config_v2plus.port_a[5] = GPIO_NUM_33; ///
    uni_gpio_config_v2plus.port_a[6] = GPIO_NUM_16; ///
    uni_gpio_config_v2plus.port_b[0] = GPIO_NUM_27;
    uni_gpio_config_v2plus.port_b[1] = GPIO_NUM_25;
    uni_gpio_config_v2plus.port_b[2] = GPIO_NUM_32;
    uni_gpio_config_v2plus.port_b[3] = GPIO_NUM_17;
    uni_gpio_config_v2plus.port_b[4] = GPIO_NUM_13;
    uni_gpio_config_v2plus.port_b[5] = GPIO_NUM_21; ///
    uni_gpio_config_v2plus.port_b[6] = GPIO_NUM_22; ///
    uni_gpio_config_v2plus.led_j1 = GPIO_NUM_5; ///
    uni_gpio_config_v2plus.led_j2 = GPIO_NUM_12; ///
    uni_gpio_config_v2plus.push_button = GPIO_NUM_15; ///    
    ...
    uni_gpio_config_v2.port_a[3] = GPIO_NUM_23; ///
    uni_gpio_config_v2.port_a[4] = GPIO_NUM_14; ///
    uni_gpio_config_v2.port_a[5] = GPIO_NUM_33; ///
    uni_gpio_config_v2.port_a[6] = GPIO_NUM_16; ///
    uni_gpio_config_v2.port_b[0] = GPIO_NUM_26;
    uni_gpio_config_v2.port_b[1] = GPIO_NUM_18;
    uni_gpio_config_v2.port_b[2] = GPIO_NUM_19;
    uni_gpio_config_v2.port_b[3] = GPIO_NUM_23;
    uni_gpio_config_v2.port_b[4] = GPIO_NUM_14;
    uni_gpio_config_v2.port_b[5] = GPIO_NUM_33; ///
    uni_gpio_config_v2.port_b[6] = GPIO_NUM_16; ///    
    uni_gpio_config_singleport.led_j1 = GPIO_NUM_12; ///
    uni_gpio_config_singleport.led_j2 = (gpio_num_t)-1; ///
    uni_gpio_config_singleport.push_button = GPIO_NUM_15; ///
...
static int unijoysticle_on_device_ready(uni_hid_device_t* d) {
    ...
    if (get_board_model() == BOARD_MODEL_UNIJOYSTICLE2_SINGLE_PORT) {
        ...
        if (used_joystick_ports & wanted_seat) {
            ...
            wanted_seat = ((uni_gamepad_seat_t)(~wanted_seat) & GAMEPAD_SEAT_AB_MASK);
        }
    }

    set_gamepad_seat(d, (uni_gamepad_seat_t)wanted_seat);
...
static void unijoysticle_on_device_oob_event(uni_hid_device_t* d, uni_platform_oob_event_t event) {
    ...
    for (int j = 0; j < UNI_HID_DEVICE_MAX_DEVICES; j++) {
        ...
        if ((bd_addr_cmp(tmp_d->conn.remote_addr, BLUEPAD_zero_addr) != 0) && ///
...
static void process_mouse(uni_hid_device_t* d, int32_t delta_x, int32_t delta_y, uint16_t buttons) {
    ...
    if (buttons != prev_buttons) {
        ...
        safe_gpio_set_level(g_uni_config->port_a_named.fire, (buttons & BUTTON_A_));
        safe_gpio_set_level(g_uni_config->port_a_named.pot_x, (buttons & BUTTON_B_));
...
static void set_gamepad_seat(uni_hid_device_t* d, uni_gamepad_seat_t seat) {
    ...
    for (int i = 0; i < UNI_HID_DEVICE_MAX_DEVICES; i++) {
        ...
        if (tmp_d == NULL)
            continue;
        if (bd_addr_cmp(tmp_d->conn.remote_addr, BLUEPAD_zero_addr) != 0) { ///
            all_seats = (uni_gamepad_seat_t) ((int)all_seats | get_unijoysticle_instance(tmp_d)->gamepad_seat );
        }
    }
...
static void mouse_send_move(int pin_a, int pin_b, uint32_t delay) {
    safe_gpio_set_level((gpio_num_t)pin_a, 1);
    delay_us(delay);
    safe_gpio_set_level((gpio_num_t)pin_b, 1);
    delay_us(delay);

    safe_gpio_set_level((gpio_num_t)pin_a, 0);
    delay_us(delay);
    safe_gpio_set_level((gpio_num_t)pin_b, 0);
    delay_us(delay);
...
static void handle_event_button() {
    ...
    for (int j = 0; j < UNI_HID_DEVICE_MAX_DEVICES; j++) {
        uni_hid_device_t* tmp_d = uni_hid_device_get_instance_for_idx(j);
        if (bd_addr_cmp(tmp_d->conn.remote_addr, BLUEPAD_zero_addr) != 0 && tmp_d->conn.control_cid != 0 && ///
    ...
    if (ins->emu_mode == EMULATION_MODE_SINGLE_JOY) {
        ...
        set_gamepad_seat(d, (uni_gamepad_seat_t)(GAMEPAD_SEAT_A | GAMEPAD_SEAT_B));

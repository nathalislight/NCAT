...
typedef SPi< MAKE_PIN(PIN_SPI_SCK), MAKE_PIN(PIN_SPI_MOSI), MAKE_PIN(PIN_SPI_MISO), MAKE_PIN(PIN_SPI_SS) > usb_spi;
#undef MAKE_PIN
...
typedef SPi< Pb1, Pb2, Pb3, Pb0 > usb_spi;
#elif  defined(__AVR_ATmega168__) || defined(__AVR_ATmega328P__)
typedef SPi< Pb5, Pb3, Pb4, Pb2 > usb_spi;
#elif defined(__AVR_ATmega644__) || defined(__AVR_ATmega644P__) || defined(__AVR_ATmega1284__) || defined(__AVR_ATmega1284P__)
typedef SPi< Pb7, Pb5, Pb6, Pb4 > usb_spi;
...
typedef SPi< P13, P11, P12, P10 > usb_spi;
#elif defined(ARDUINO_SAM_DUE) && defined(__SAM3X8E__)
typedef SPi< P76, P75, P74, P10 > usb_spi;
#elif defined(RBL_NRF51822)
typedef SPi< P16, P18, P17, P10 > usb_spi;
#elif defined(ESP8266)
typedef SPi< P14, P13, P12, P15 > usb_spi;
#elif defined(ESP32)
typedef SPi< P18, P23, P19, P5 > usb_spi;
#elif defined(ARDUINO_NRF52840_FEATHER)
typedef SPi< P26, P25, P24, P5 > usb_spi;
#else
...
template< typename SPI_SS, typename INTR > class MAX3421e /* : public usb_spi */ {

...
struct MOUSEINFO {
//--------------------------------------------------------------------------------
///        uint8_t dDummy; ///when is enabled HID_RPT_PROTOCOL! every mouse is different ahh...
//--------------------------------------------------------------------------------
        struct {
...
protected:
        ...
        virtual void OnWheelMove(MOUSEINFO *mi __attribute__((unused))) { ///NCX:
        };

        virtual void CustomParser(uint8_t len, uint8_t *buf) { ///NCX:
        };

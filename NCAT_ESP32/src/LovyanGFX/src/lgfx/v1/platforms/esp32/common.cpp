...
extern uint32_t FREQ___(uint32_t HERTZ);
...
// There is problem when overclocked:
  uint32_t getApbFrequency(void)
  {
    ...
    if (conf.freq_mhz >= 80){ //fixing more than 80MHz (when overclock)
      return FREQ___(80 * 1000000);
    }

...
#if I2S_ENABLED
#else				   
///extern void audio_write_16(int16_t* s, int pos, int len, int channels);
///extern uint32_t _audio_r;
///extern uint32_t _audio_w;

///extern 
void pwm_audio_write_0(uint8_t *inbuf, size_t len, size_t *bytes_written, TickType_t ticks_to_wait);
///extern 
void pwm_audio_set_param_0(int rate, int bits, int ch);
#endif
...
///    const size_t m_buffSizePSRAM = 300000; // most webstreams limit the advance to 100...300Kbytes
    ...
    const size_t m_buffSizePSRAM   = 1600 * 5; ///NCX increase mp3 switching speed...
